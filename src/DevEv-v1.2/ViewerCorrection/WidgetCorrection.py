...
class CorrectionWindow(QWidget):
    ...
    def setHW(self, h, w):
        if h == 0 or w == 0:
            ...
            self.cams = read_cameras("metadata/CameraParameters/camera_BottomLeft_trim.npy")
        self.h, self.w = 720, 1280
        if h == 720 and w == 1280:
            self.cams = read_cameras("metadata/CameraParameters/camera_BottomLeft_trim.npy")
        else:
            self.cams = read_cameras("metadata/CameraParameters/camera_MobileInfants_trim.npy")
