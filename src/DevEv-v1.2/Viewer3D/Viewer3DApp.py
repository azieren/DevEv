...
class View3D(gl.GLViewWidget):
    def __init__(self):
        ...
        self.plane_dict = self.read_planes('metadata/RoomData/room_setup2.json')
        self.attention = self.read_attention("metadata/RoomData/attention.txt")
    ...
    def draw_planes(self):
        ...
        img = cv2.imread("metadata/RoomData/ceiling_reconstructed.png")
    ...
    def read_attention(self, filename="metadata/RoomData/attention.txt"):
    ...
    def read_planes(self, filename):
        ...
        plane_list = np.load("metadata/RoomData/room_setup_obj.npy", allow_pickle=True)
